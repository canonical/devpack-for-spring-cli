...
public class PathResolverTests {
	...
	@Test
	public void resolvesChildItem() {
		Path baseDir = Path.of("base");
		Path child = Path.of("child");

		assertThat(PathResolver.resolve(baseDir, child)).isEqualTo(baseDir.resolve(child));
	}

	@Test
	public void failsToResolveItemOutsideBaseDir() {
		Path baseDir = Path.of("base");
