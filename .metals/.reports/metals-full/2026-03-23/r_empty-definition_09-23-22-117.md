error id: file://<WORKSPACE>/src/main/java/com/canonical/devpackspring/rewrite/AddGradlePluginRecipe.java:com/canonical/devpackspring/rewrite/AddGradlePluginRecipe#visitor.
file://<WORKSPACE>/src/main/java/com/canonical/devpackspring/rewrite/AddGradlePluginRecipe.java
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol com/canonical/devpackspring/rewrite/AddGradlePluginRecipe#visitor.
empty definition using fallback
non-local guesses:

offset: 1410
uri: file://<WORKSPACE>/src/main/java/com/canonical/devpackspring/rewrite/AddGradlePluginRecipe.java
text:
```scala
/*
