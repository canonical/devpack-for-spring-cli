error id: file://<WORKSPACE>/src/main/java/com/canonical/devpackspring/rewrite/AddConfigurationRecipe.java:_empty_/KotlinIsoVisitor#
file://<WORKSPACE>/src/main/java/com/canonical/devpackspring/rewrite/AddConfigurationRecipe.java
empty definition using pc, found symbol in pc: _empty_/KotlinIsoVisitor#
...
public class AddConfigurationRecipe extends Recipe {
	...
	public TreeVisitor<?, ExecutionContext> getVisitor() {
		if (kotlin) {
			...
			return new KotlinIs@@oVisitor<ExecutionContext>() {
						@Override
