error id: file://<WORKSPACE>/src/main/java/com/canonical/devpackspring/rewrite/AddConfigurationRecipe.java:_empty_/configCu#
file://<WORKSPACE>/src/main/java/com/canonical/devpackspring/rewrite/AddConfigurationRecipe.java
empty definition using pc, found symbol in pc: _empty_/configCu#
		...
		if (kotlin) {
			...
			return new KotlinIsoVisitor<ExecutionContext>() {
						...
						public K.CompilationUnit visitCompilationUnit(K.CompilationUnit cu,
							...
							for (Statement configStmt : confi@@gCu.getStatements()) {
